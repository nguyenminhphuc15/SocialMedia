...
CREATE TABLE IF NOT EXISTS Story (
    ...
    CreatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    ExpiresAt TIMESTAMP NULL,  -- Cho phép NULL, tính toán trong backend
...
CREATE TABLE IF NOT EXISTS StoryView (
    StoryViewId INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS StoryHighlight (
    StoryHighlightId INT PRIMARY KEY AUTO_INCREMENT,
    UserId INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS StoryHighlightItem (
    StoryHighlightItemId INT PRIMARY KEY AUTO_INCREMENT,
    StoryHighlightId INT NOT NULL,
    StoryId INT NOT NULL,
    OrderIndex INT DEFAULT 0,
    FOREIGN KEY (StoryHighlightId) REFERENCES StoryHighlight(StoryHighlightId) ON DELETE CASCADE,
    FOREIGN KEY (StoryId) REFERENCES Story(StoryId) ON DELETE CASCADE
);